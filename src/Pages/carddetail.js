...
const courses = [
  {
    ...
    description:
      "Jolly Phonics for Kindergarten<br />CBSE Hindi Coaching (Grades 3-9)<br />Eight-Level Hindi Program<br/>CEO-Based Customized Spoken Hindi Course<br/>Hindi Diploma Course",
  ...
  },
  {
    ...
    description:
      "CEO-Based Customized Course<br />Special programs for Government School Students, College Students, and Homemakers",
        ...
        {courses.map((course, index) => (
          ...
          >
            <Card
              ...
              style={{
                backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url(${course.image})`,
